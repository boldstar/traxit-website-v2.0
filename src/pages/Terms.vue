<template>
    ...
    <div class="terms">
        ...
        <h4>Dated: May 14, 2019</h4>

        <h4>Welcome to TRAXIT</h4>

        <strong>TRAXIT</strong>, a service of <strong>Alytix Ventures LLC</strong> (“our”, “us”, “we”, and “TRAXIT”) offers proprietary services and certain content that we may provide through any of our websites (any of which and all together, the “Service”) that is designed to enable you (personally and, if applicable, on behalf of the entity for whom you are using the Service; collectively, “you” or “Customer”) to manage and track client work.

        <strong>PLEASE NOTE:</strong> THESE TERMS CONTAIN A DISPUTE RESOLUTION AND ARBITRATION PROVISION, INCLUDING CLASS ACTION WAIVER THAT AFFECTS YOUR RIGHTS UNDER THESE TERMS AND WITH RESPECT TO DISPUTES YOU MAY HAVE WITH THE BANTER. YOU MAY OPT OUT OF THE ARBITRATION AND CLASS ACTION WAIVER AS PROVIDED BELOW.

        <h4>Customer’s Acceptance of this Agreement</h4>

        Before we can permit use of the Service, it is important to us that we have a common understanding concerning the terms and conditions that govern such use. This document and the documents that we incorporate by making reference to them here, like our privacy policy (“Privacy Policy”) and pricing and terms set forth on the fee schedule (“Fee Schedule”) (collectively, the “Agreement”), together set forth and establish our common understanding about your use of the Service. When you create an account or use the Service, you agree to be bound by this Agreement. Please read this Agreement carefully and save it. If you would like us to send you a copy for your records, you can request that by sending us an email at support@traxit.io. If you do not agree with it, you should not use the Service.

        <h4>Representations About Customer</h4>
        ...
        Your account is automatically billed in advance when you subscribe to use our proprietary service and again on each monthly, yearly or semi-yearly anniversary (depending on the subscription term you choose) of the date you initially subscribed.

        <h4>Refunds</h4>

        New customers on annual or biennial subscription plans are entitled to a full refund during the 30-day guarantee period, defined as the first 30 days of the original paid subscription term. Monthly subscription charges will not be refunded upon cancellation.
        Customers on annual or biennial plans who do not provide notice of their intent to cancel prior to their subscription renewal date will be offered a grace period of 10 business days to cancel their subscription. Account cancellation requests received during this grace period will result in a full refund less a 3% transaction fee. Cancellation requests received after the 10 business day grace period will result in cancellation of the account effective at the end of the current subscription period. A refund will not be provided in these circumstances.

        <h4>Account Changes</h4>

        Additional seats can be added to your current subscription at any point during your subscription term. When additional seats are added, you will be charged a prorated amount for the additional subscription access and will receive a prorated invoice detailing the new charges.
        Account downgrades – reducing the number of seats on your current plan or decreasing the length of your subscription term – made in the middle of a subscription term will result in an account credit that will be automatically applied to a future invoice. Downgrades made after the 10 business day grace period will not result in a refund of charges.
        If you cancel your account, you will not be billed again and you may continue to use the Service for the remainder of your then-current subscription term.

        <h4>Payment Terms</h4>

        We accept Visa, MasterCard, and American Express. Upon failure of a monthly credit card charge, we will make up to three additional attempts to run the charge within 3 weeks of your original billing due date. After a third failed attempt, we will immediately suspend your account. We may also, at our discretion and in addition to any other remedies we may have, suspend your and your Authorized Users’ access to the Service. Upon account cancellation, we will erase all of your account data from the system within 3 months. You are responsible for ensuring you have any necessary local backups of your data before requesting cancellation.
        ...
        Notwithstanding any other provisions of this Agreement, TRAXIT may monitor Customer’s use of the Service and use data and information related to such use and Content in an aggregated and anonymous manner, including to compile statistical and performance information related to the provision and operation of the Service (“Aggregated Statistics”). As between TRAXIT and Customer, all right, title and interest in the Aggregated Statistics and all Intellectual Property Rights therein, belong to and are retained solely by TRAXIT. Customer acknowledges that TRAXIT will be compiling Aggregated Statistics based on Customer’s Content and information and content input by other customers into the Service and Customer agrees that we may (a) make such Aggregated Statistics publicly available, and (b) use such information to the extent and in the manner required by applicable law or regulation and for purposes of data gathering, analysis, service enhancement and marketing, provided that such data and information does not identify Customer or its Confidential Information.

        <h4>Customer Representations About the Content</h4>
        ...
        Our Service includes links to other web sites or services whose privacy practices may differ from those of TRAXIT. Your information is governed by their privacy policies. We encourage you to carefully read the privacy policy of any web site you visit.

        <h4>Third Party Terms</h4>
        ...
        Certain Third Party Services may be integrated with the Service. These Third Party Services are not provided by TRAXIT. Your ability to use the Third Party Services may be limited according to the applicable Third Party Terms. When you integrate with a Third Party Service, you authorize us to exchange any of your data, whether confidential or not, with the Third Party Service, including without limitation Intuit, Google email and Google calendar, so you can take advantage of integration with the Services. Such data may include Customer’s or Customer’s clients’ financial or personal information with third parties. In addition, Customer agrees that we may provide such Customer data to the third party service provider. Customer represents and warrants that Customer has the rights and authority to provide such authorizations to the third party service providers and TRAXIT. Customer’s use and/or access to Third Party Services shall be limited to those uses and access rights permitted by the third party service provider. If Customer accesses or uses the Third Party Services, Customer is responsible for reviewing and understanding any Third Party Terms governing such Third Party Services. Any links to a Third Party Service or website that you find in the Service are provided for convenience only and we do not control or endorse any material or information found on those third party sites. Customer understands that Developer has no control over the Third Party Services and that Customer’s ability to access and use the Third Party Services may be suspended or terminated at any time, for any reason, at the third party service provider’s discretion.

        <h4>Limitations on Availability</h4>
        ...
        CUSTOMER UNDERSTANDS AND AGREES THAT ANY USE OF THE SERVICES, THIRD PARTY SERVICES OR DATA PROVIDED VIA THE THIRD PARTY SERVICES OR SERVICES WILL BE AT CUSTOMER’S SOLE RISK, AND THAT, IF THERE IS ANY LIABILITY IN CONNECTION WITH THE SERVICES, INCLUDING LIABILITY ARISING FROM A SECURITY BREACH OR TRAXIT’S LACK OF COMPLIANCE WITH APPLICABLE LAWS OR REGULATIONS OR DATA PRIVACY PROTECTION, SUCH LIABILITY IS SOLELY WITH TRAXIT AND NOT ITS LICENSORS OR THIRD PARTY SERVICE PROVIDERS. NO ORAL OR WRITTEN INFORMATION OR ADVICE THAT WE GIVE SHALL CREATE A WARRANTY. SOME JURISDICTIONS DO NOT ALLOW THE EXCLUSION OF IMPLIED WARRANTIES OR LIMITATIONS ON APPLICABLE STATUTORY RIGHTS OF A CONSUMER, SO THE ABOVE EXCLUSION AND LIMITATIONS MAY NOT APPLY.
        ...
        <h4>Export and Other Restrictions</h4>
        ...
        <h4>Consent to Receive Commercial E-Mail</h4>
        ...
        Notwithstanding the above, you or we may choose to pursue a Dispute in court and not by arbitration if: (a) the dispute qualifies for initiation in small claims court; or (b) YOU OPT-OUT OF THESE ARBITRATION PROCEDURES WITHIN 30 DAYS FROM THE DATE THAT YOU FIRST CONSENT TO THIS AGREEMENT (the “Opt-Out Deadline”). You may opt-out of this Dispute Resolution Provision by emailing us at support@traxit.io the following information: (1) your name; (2) your address; (3) a clear statement that you do not wish to resolve disputes with us through arbitration. Either way, we will not take any decision you make personally.  In fact, your decision to opt-out of this Dispute Resolution Provision will have no adverse effect on your relationship with us. But, we do have to enforce the Opt-Out Deadline so keep in mind that any opt-out request received after the Opt-Out Deadline will not be valid and you must pursue your dispute in arbitration or small claims court, as applicable.
        ...
        When you register for TRAXIT, we ask for information such as your name, company name, email address, billing address, and credit card information. TRAXIT uses this collected information for the following general purposes: products and services provision, billing, identification and authentication, services improvement, contact, and research.
        ...
        If TRAXIT is acquired by or merged with another company. In this event, we will notify you before information is transferred and becomes subject to a different privacy policy.

        <h4>Data Storage</h4>

        TRAXIT uses third-party vendors and partners to provide the necessary hardware, software, networking, storage, and related technology required to run our service. Although TRAXIT owns the code, databases, and all rights to the TRAXIT application, you retain all rights to your data.

        <h4>Cookies</h4>

        A cookie is a small amount of data, which often includes an anonymous unique identifier, that is sent to your browser from a website’s computer and stored on your computer’s hard drive. Cookies are required to use TRAXIT We use cookies to record current session information. You are required to sign in to your TRAXIT account after a certain period of time has elapsed to protect you against others accidentally accessing your account contents.
        Changes

        TRAXIT  may periodically update this policy. We will notify you about significant changes in the way we treat personal information by sending a notice to the primary email address specified in your TRAXIT primary account holder account or by placing a prominent notice on our site.

        <h4>Contact Us</h4>

        We can be reached by email at support@traxit.io or our support line, (936) 213-0639, Monday-Friday, 9am EST – 5pm EST.
    </div>
    </Layout>
</template>
